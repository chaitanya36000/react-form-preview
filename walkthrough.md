...
I have successfully extracted the `PreviewMode` component into a standalone package named `form-preview`. This package is now self-sufficient and can be installed in other projects directly from GitHub.
...
npm install github:chaitanya36000/form-preview

# Install a specific version (after creating a GitHub Release/Tag)
npm install github:chaitanya36000/form-preview#v1.0.0
```
> [!IMPORTANT]
...
### Usage in React
```tsx
import { PurePreview } from 'form-preview';
import 'form-preview/dist/index.css'; // If styles are separately bundled
